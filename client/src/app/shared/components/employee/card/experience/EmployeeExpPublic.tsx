...
interface EmployeeExpPublicProps {
    experienceList?: Experience[];
}

export default function EmployeeExpPublic({ experienceList = [] }: EmployeeExpPublicProps) {
    ...
    const { years, months, days } = calculatePublicTotal();
    return (
